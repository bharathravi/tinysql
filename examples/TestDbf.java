...
public class TestDbf {
    ...
    public static void main(String argv[]) {
        ...
        try { // watch out for SQLExceptions!
            ...
            p.setProperty ("autoenc", "true");
            p.setProperty ("encoding", "Cp850");
            p.setProperty ("tabletype", "visualfoxpro");
            
            DriverManager.setLogStream (System.out);      
            Connection con = DriverManager.getConnection("jdbc:dbfFile:./test", p);
            ...
            System.out.println("=====================");
            executeUpdate(stmt, "CREATE TABLE party (birthday TIMESTAMP, age INT)");
            ...
            System.out.println("====================");
            executeUpdate(stmt, "INSERT INTO party (birthday, age) VALUES('2000-12-01 12:00:00', 1)");
          ...
          System.out.println("=======================");
          rs = executeQuery(stmt, "SELECT * FROM people where (pe_name='Hef') or (pe_name='Bull Lee')");
          System.out.println ("No Of Recs: " + QueryDbf.displayResults(rs));
