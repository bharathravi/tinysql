 ...
 */
public class InMemoryTextFileTable extends tinySQLTable
{
   ...
   *
   */
  public InMemoryTextFileTable(String dDir, String table_name, textFileDatabase engine) throws tinySQLException
  {
    super(table_name);
    ...
    //
    //System.out.println("Opening InMemory TextFile");
    try
    {
      if (readonly)
      {
        ftbl = new MemoryFile(dataDir + "/" + table_name + tableext, "r");
      }
      else
      {
        ftbl = new MemoryFile(dataDir + "/" + table_name + tableext, "rw");
      }
    }
    catch (Exception e)
    {
   ...
   * @see ORG.as220.tinySQL.tinySQLTable#UpdateCurrentRow
   * @throws ORG.as220.tinySQL.tinySQLException if an database error occured or the database is
   * readonly
   */
  public synchronized void updateRow(int row, tsRawRow values)
      throws tinySQLException
  {
    ...
    if (values instanceof textFileRow)
    {
   ...
   * @see ORG.as220.tinySQL.tinySQLTable#InsertRow()
   *
   */
   ...
   * @throws ORG.as220.tinySQL.tinySQLException if an IOError or an database error occured.
   */
   ...
   * @see ORG.as220.tinySQL.tinySQLTable#DeleteRow
   *
   */
   ...
   * @throws ORG.as220.tinySQL.tinySQLException on database or IO error
   * @see ORG.as220.tinySQL.tinySQLTable#isDeleted()
   */
