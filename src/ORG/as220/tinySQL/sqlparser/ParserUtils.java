...
//  private static GregorianCalendar cal = new GregorianCalendar ();
  ...
  public static void getColumnElements(Vector v, LValue root)
  {
    ...
    {
      Enumeration childrenEnum = root.getChildren();
      while (childrenEnum.hasMoreElements())
      {
        LValue val = (LValue) childrenEnum.nextElement();
   ...
   */
  public static Vector buildVector(Enumeration elementEnum)
  {
    Vector retval = new Vector();
    while (elementEnum.hasMoreElements())
    {
      retval.add(elementEnum.nextElement());
    }
    return retval;
  }
