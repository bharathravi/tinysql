//=============================================================================
/*
$Id: tinySQLPreparedStatement.java,v 1.4 2002/10/25 14:01:41 taq Exp $
*/
//=============================================================================
/**
    ...
    implements PreparedStatement
{
  ...
  {
    Enumeration elementEnum = parameters.elements();

    //Very simples isn't:
    while (elementEnum.hasMoreElements())
    {
      ParameterValue val = (ParameterValue) elementEnum.nextElement();
      val.clear();
    }
  }
